...
<body>
    ...
    <section id="grid" class="section group">
        <main class="col span_8_of_12">
            <article>
            <!-- Main Text Goes Here -->
                <h2>Packet Pick Up Information</h2>
                <p>
                ...
                <p>
                    Long Course SWIM - 1.2mi - Participants will make two counter-clockwise loops. Large buoys will mark the turn points. Kayakers will be positioned on the water to support the swimmers. Medical support will be present on the beach.
                </p>
                <p>
            ...
            <article>
                ...
                <h3>Saturday</h3>
                <p>
                    <strong>Long Course Triathlon</strong>
                    <br>
                    7:00 AM 
                    <br>
                    <strong>Olympic Triathlon</strong>
                    <br>
                    7:30 AM 
                    <br>
                    <strong>10K</strong>
                ...
                <p>
                    <strong>Sprint Triathlon</strong>
                    <br>
                    8:00 AM 
                    <br>
