    ...
    <section id="grid" class="section group">
        <main class="col span_8_of_12">
            ...
            <!-- Pic Gallery or Form Goes Here -->
                <h2>Kitten savannah tabby</h2>
                <h3>Cornish rex havana brown abyssinian</h3>
                <p>Lion british shorthair bengal yet leopard and kitty havana brown. Kitty scottish fold and tabby cheetah. Leopard balinese cornish rex but maine coon, for lion. Tiger lion so manx for savannah tom. Tom bengal ocelot.</p>
            </article>
        </main>
